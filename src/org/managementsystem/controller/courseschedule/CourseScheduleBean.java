...
import org.managementsystem.model.course.CourseScheduleDAOImpl;
import org.primefaces.event.DragDropEvent;

@ManagedBean(name = "dragDrop")
@ApplicationScoped
public class CourseScheduleBean {
    private CourseScheduleController controller=new CourseScheduleController(new CourseScheduleDAOImpl());
